...
Define how LiveDocs evolves app-global and per-workspace SQLite schemas through independent compatibility epochs and forward migration versions, including intentional destructive resets for incompatible schema families.
